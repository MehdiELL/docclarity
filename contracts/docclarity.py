...
# DocClarity - AI documentation-clarity rater on GenLayer.
# Submit a URL; GenLayer validators independently evaluate it with an LLM, agree on a label and score by consensus, and write the result on chain. AI documentation-clarity rater.
...
SCORE_TOLERANCE = 25
CATEGORIES = ("clear", "adequate", "confusing")
DEFAULT_LABEL = "adequate"
...
class DocClarity(gl.Contract):
    ...
    def evaluate(self, item_id: int) -> None:
        ...
        def leader_fn():
            ...
            prompt = f"""You are a technical writer. Judge how clear and usable the DOCUMENTATION page is.
...
Classify the CONTENT as exactly one of: clear, adequate, confusing.
Also give an integer clarity score from 0 to 100, and a one-sentence reason.

Respond with ONLY JSON: {{"label": "<one of: clear, adequate, confusing>", "score": <integer 0-100>, "reasoning": "<one sentence>"}}"""
